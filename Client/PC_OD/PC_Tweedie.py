...
# find_separation(df_train, "cc_range")
# find_separation(df_train, "make_name_new")
# find_separation(df_train, "supplier_name_new")
# find_separation(df_train, "fuel_type_new")
# find_separation(df_train, "revised_plan_category_new")

variable_lost = ("cc_range make_name_new revised_plan_category_new fuel_type_new supplier_name_new ncb "
                 "policy_type model_name_new age_range registration_rto_code_new").split()
...
make_pivots(df_test, "ncb")
make_pivots(df_test, "policy_type")
make_pivots(df_test, "model_name_new")
make_pivots(df_test, "age_range")
make_pivots(df_test, "registration_rto_code_new")
