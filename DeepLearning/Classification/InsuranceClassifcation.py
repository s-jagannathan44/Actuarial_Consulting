...
# Step 4 create  a copy and split  using GroupShuffleSplit instead of train_test_split
...
# Step 5 Check if the proportion of train set to test set is indeed 80:20
print("train %age ", len(train)/len(df_freq_ml))
print("test %age ", len(test)/len(df_freq_ml))

# Step 6 check if the average claims frequencies are similar between train set and test set.
...
# Step 7 Check the sum of Exposure and count of ClaimNb in the train and test sets.
